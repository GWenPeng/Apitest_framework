...
class ncTUpgradePackageInfo(object):
    ...
    def __init__(self, package_version="", support_version="", import_time=0, package_hash="", hash_algorithm="", package_name="", package_size=0, package_oss_id="",):
        ...
        self.package_oss_id = package_oss_id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.package_oss_id = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.package_size is not None:
            ...
            oprot.writeFieldEnd()
        if self.package_oss_id is not None:
            oprot.writeFieldBegin('package_oss_id', TType.STRING, 8)
            oprot.writeString(self.package_oss_id.encode('utf-8') if sys.version_info[0] == 2 else self.package_oss_id)
            oprot.writeFieldEnd()
...
ncTUpgradePackageInfo.thrift_spec = (
    ...
    (8, TType.STRING, 'package_oss_id', 'UTF8', "", ),  # 8
)
