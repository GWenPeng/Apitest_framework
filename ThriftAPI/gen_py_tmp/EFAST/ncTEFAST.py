...
class Iface(object):
    ...
    def EFAST_AddUserDoc(self, userId, totalQuotaBytes, responsiblePersonId, ossId):
        """
        创建个人文档
    ...
    def EFAST_EditDocLibraryOSSId(self, docId, ossId):
        """
        设置文档库对象存储
...
class Client(Iface):
    ...
    def EFAST_AddUserDoc(self, userId, totalQuotaBytes, responsiblePersonId, ossId):
        ...
        """
        self.send_EFAST_AddUserDoc(userId, totalQuotaBytes, responsiblePersonId, ossId)
        self.recv_EFAST_AddUserDoc()

    def send_EFAST_AddUserDoc(self, userId, totalQuotaBytes, responsiblePersonId, ossId):
    ...
    def EFAST_EditDocLibraryOSSId(self, docId, ossId):
        ...
        """
        self.send_EFAST_EditDocLibraryOSSId(docId, ossId)
        self.recv_EFAST_EditDocLibraryOSSId()

    def send_EFAST_EditDocLibraryOSSId(self, docId, ossId):
        self._oprot.writeMessageBegin('EFAST_EditDocLibraryOSSId', TMessageType.CALL, self._seqid)
        args = EFAST_EditDocLibraryOSSId_args()
        args.docId = docId
        args.ossId = ossId
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_EFAST_EditDocLibraryOSSId(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = EFAST_EditDocLibraryOSSId_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.exp is not None:
            raise result.exp
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["EFAST_EditDocLibraryOSSId"] = Processor.process_EFAST_EditDocLibraryOSSId
    ...
    def process_EFAST_AddUserDoc(self, seqid, iprot, oprot):
        ...
        result = EFAST_AddUserDoc_result()
        try:
            self._handler.EFAST_AddUserDoc(args.userId, args.totalQuotaBytes, args.responsiblePersonId, args.ossId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except EThriftException.ttypes.ncTException as exp:
    ...
    def process_EFAST_EditDocLibraryOSSId(self, seqid, iprot, oprot):
        args = EFAST_EditDocLibraryOSSId_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = EFAST_EditDocLibraryOSSId_result()
        try:
            self._handler.EFAST_EditDocLibraryOSSId(args.docId, args.ossId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except EThriftException.ttypes.ncTException as exp:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("EFAST_EditDocLibraryOSSId", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class EFAST_AddUserDoc_args(object):
    ...
    def __init__(self, userId=None, totalQuotaBytes=None, responsiblePersonId=None, ossId=None,):
        self.userId = userId
    ...
    def write(self, oprot):
        ...
        if self.ossId is not None:
            oprot.writeFieldBegin('ossId', TType.STRING, 4)
...
EFAST_AddUserDoc_args.thrift_spec = (
    ...
    (4, TType.STRING, 'ossId', 'UTF8', None, ),  # 4
)
...
class EFAST_EditDocLibraryOSSId_args(object):
    """
    Attributes:
     - docId
     - ossId
    ...
    def __init__(self, docId=None, ossId=None,):
        self.docId = docId
        self.ossId = ossId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('EFAST_EditDocLibraryOSSId_args')
        if self.docId is not None:
            oprot.writeFieldBegin('docId', TType.STRING, 1)
            oprot.writeString(self.docId.encode('utf-8') if sys.version_info[0] == 2 else self.docId)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(EFAST_EditDocLibraryOSSId_args)
EFAST_EditDocLibraryOSSId_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'docId', 'UTF8', None, ),  # 1
...
class EFAST_EditDocLibraryOSSId_result(object):
    """
    Attributes:
     - exp
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('EFAST_EditDocLibraryOSSId_result')
        if self.exp is not None:
            oprot.writeFieldBegin('exp', TType.STRUCT, 1)
            self.exp.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(EFAST_EditDocLibraryOSSId_result)
EFAST_EditDocLibraryOSSId_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'exp', [EThriftException.ttypes.ncTException, None], None, ),  # 1
)
