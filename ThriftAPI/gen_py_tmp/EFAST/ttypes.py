...
class ncTEFASTError(object):
    ...
    NCT_OSS_NOT_EXIST = 20054
    NCT_OSS_HAS_BEEN_DISABLED = 20055
    FAILED_TO_CREATE_ETS_OSS_MANAGER = 20056
    ...
    _VALUES_TO_NAMES = {
        ...
        20054: "NCT_OSS_NOT_EXIST",
        20055: "NCT_OSS_HAS_BEEN_DISABLED",
        20056: "FAILED_TO_CREATE_ETS_OSS_MANAGER",
    }
...
class ncTAddCustomDocParam(object):
    ...
    def __init__(self, name=None, typeName=None, createrId=None, ownerIds=None, spaceQuota=None, ossId=None, relateDepartId=None, perm=None,):
        self.name = name
    ...
    def write(self, oprot):
        ...
        if self.ossId is not None:
            oprot.writeFieldBegin('ossId', TType.STRING, 6)
...
class ncTAddCustomDocParamEx(object):
    ...
    def __init__(self, name=None, typeName=None, createrId=None, ownerIds=None, spaceQuota=None, objId=None, permConfigs=None, ossId=None,):
        self.name = name
        self.typeName = typeName
        self.createrId = createrId
        self.ownerIds = ownerIds
    ...
    def write(self, oprot):
        ...
        if self.permConfigs is not None:
            ...
            oprot.writeFieldEnd()
        if self.ossId is not None:
            oprot.writeFieldBegin('ossId', TType.STRING, 8)
            oprot.writeString(self.ossId.encode('utf-8') if sys.version_info[0] == 2 else self.ossId)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncTEditCustomDocParam(object):
    ...
    def __init__(self, docId=None, name=None, typeName=None, ownerIds=None, spaceQuota=None, userId=None, ossId=None,):
        self.docId = docId
        self.name = name
        self.typeName = typeName
        self.ownerIds = ownerIds
    ...
    def write(self, oprot):
        ...
        if self.userId is not None:
            ...
            oprot.writeFieldEnd()
        if self.ossId is not None:
            oprot.writeFieldBegin('ossId', TType.STRING, 7)
            oprot.writeString(self.ossId.encode('utf-8') if sys.version_info[0] == 2 else self.ossId)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncTDocOSSInfo(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncTDocOSSInfo')
        if self.ossId is not None:
...
class ncTCustomDocInfo(object):
    ...
    def __init__(self, docId=None, name=None, typeName=None, createrId=None, createrName=None, ownerInfos=None, spaceQuota=None, usedSize=None, usedSpaceRate=None, ossInfo=None, relateDepartName=None, relateDepartId=None, displayOrder=None,):
        self.docId = docId
        self.name = name
        self.typeName = typeName
        self.createrId = createrId
    ...
    def write(self, oprot):
        ...
        if self.ossInfo is not None:
            oprot.writeFieldBegin('ossInfo', TType.STRUCT, 10)
...
class ncTAddArchiveDocParam(object):
    ...
    def __init__(self, name=None, createrId=None, ownerId=None, spaceQuota=None, ossId=None,):
        self.name = name
        self.createrId = createrId
        self.ownerId = ownerId
        self.spaceQuota = spaceQuota
    ...
    def write(self, oprot):
        ...
        if self.spaceQuota is not None:
            ...
            oprot.writeFieldEnd()
        if self.ossId is not None:
            oprot.writeFieldBegin('ossId', TType.STRING, 5)
            oprot.writeString(self.ossId.encode('utf-8') if sys.version_info[0] == 2 else self.ossId)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncTEditArchiveDocParam(object):
    ...
    def __init__(self, docId=None, name=None, ownerId=None, spaceQuota=None, userId=None, ossId=None,):
        self.docId = docId
        self.name = name
        self.ownerId = ownerId
        self.spaceQuota = spaceQuota
...
class ncTArchiveDocInfo(object):
    ...
    def __init__(self, docId=None, name=None, createrId=None, createrName=None, ownerInfo=None, spaceQuota=None, usedSize=None, usedSpaceRate=None, ossInfo=None,):
        self.docId = docId
        self.name = name
        self.createrId = createrId
        self.createrName = createrName
    ...
    def write(self, oprot):
        ...
        if self.usedSpaceRate is not None:
            ...
            oprot.writeFieldEnd()
        if self.ossInfo is not None:
            oprot.writeFieldBegin('ossInfo', TType.STRUCT, 9)
            self.ossInfo.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
ncTAddCustomDocParam.thrift_spec = (
    ...
    (6, TType.STRING, 'ossId', 'UTF8', None, ),  # 6
...
ncTAddCustomDocParamEx.thrift_spec = (
    ...
    (8, TType.STRING, 'ossId', 'UTF8', None, ),  # 8
)
...
ncTEditCustomDocParam.thrift_spec = (
    ...
    (7, TType.STRING, 'ossId', 'UTF8', None, ),  # 7
)
...
all_structs.append(ncTDocOSSInfo)
ncTDocOSSInfo.thrift_spec = (
    None,  # 0
...
ncTCustomDocInfo.thrift_spec = (
    ...
    (10, TType.STRUCT, 'ossInfo', [ncTDocOSSInfo, None], None, ),  # 10
...
ncTAddArchiveDocParam.thrift_spec = (
    ...
    (5, TType.STRING, 'ossId', 'UTF8', None, ),  # 5
)
...
ncTArchiveDocInfo.thrift_spec = (
    ...
    (9, TType.STRUCT, 'ossInfo', [ncTDocOSSInfo, None], None, ),  # 9
)
