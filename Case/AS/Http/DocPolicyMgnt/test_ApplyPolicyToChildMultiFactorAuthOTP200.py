...
class Test_ApplyPolicyToChildMultiFactorAuthOTP200(object):
    ...
    def teardown(self, metadata_host):
        ...
        # 新增策略
        policyid = CommonDocPolicyMgnt().AddPolicy("{\"content\":[{\"name\":\"multi_factor_auth\",\"value\":{"
                                                   "\"enable\":True,\"image_vcode\":False,\"otp\":True,"
                                                   "\"password_error_count\":50,\"sms_vcode\":False}}],"
                                                   "\"name\":\"policy\"}")
        # 获取子域凭据
    ...
    def test_ApplyPolicyToChildMultiFactorAuthOTP200(self, teardown):
        policyid = teardown[0]
...
if __name__ == '__main__':
    pytest.main(['-q', '-v', 'test_ApplyPolicyToChildMultiFactorAuthOTP200.py'])
